...
func newPicture(db *gorm.DB, opts ...gen.DOOption) picture {
	...
	_picture.ID = field.NewInt32(tableName, "id")
	_picture.Description = field.NewString(tableName, "description")
	_picture.Value = field.NewBytes(tableName, "value")
	_picture.Post = field.NewInt32(tableName, "post")
...
func (p *picture) updateTableName(table string) *picture {
	...
	p.Value = field.NewBytes(table, "value")
	p.Post = field.NewInt32(table, "post")
...
func (p *picture) WithContext(ctx context.Context) *pictureDo { return p.pictureDo.WithContext(ctx) }

func (p picture) TableName() string { return p.pictureDo.TableName() }

func (p picture) Alias() string { return p.pictureDo.Alias() }
