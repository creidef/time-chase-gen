...
func newAuth(db *gorm.DB, opts ...gen.DOOption) auth {
	...
	_auth.AuthID = field.NewInt32(tableName, "auth_id")
	...
	_auth.Email = field.NewString(tableName, "email")
	_auth.Password = field.NewString(tableName, "password")
	_auth.VerifyEmail = field.NewInt32(tableName, "verify_email")
...
func (a *auth) updateTableName(table string) *auth {
	...
	a.AuthID = field.NewInt32(table, "auth_id")
	a.CreatedAt = field.NewTime(table, "created_at")
	a.UpdatedAt = field.NewTime(table, "updated_at")
	a.DeletedAt = field.NewField(table, "deleted_at")
	a.Email = field.NewString(table, "email")
	a.Password = field.NewString(table, "password")
	a.VerifyEmail = field.NewInt32(table, "verify_email")
...
func (a *auth) fillFieldMap() {
	...
	a.fieldMap["verify_email"] = a.VerifyEmail
}
